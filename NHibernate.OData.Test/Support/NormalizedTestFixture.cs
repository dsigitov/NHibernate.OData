...
namespace NHibernate.OData.Test.Support
{
    internal abstract class NormalizedTestFixture : ParserTestFixture
    {
        ...
        {
            base.Verify(actual.Visit(new AliasingNormalizeVisitor(ODataSessionFactoryContext.Empty,  null, true, null)), expected);
        }
        ...
        {
            return expression.Visit(new AliasingNormalizeVisitor(ODataSessionFactoryContext.Empty, null, true, null));
        }
    }
}
